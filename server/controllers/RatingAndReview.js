...
exports.getAverageRating = async (req,res) => {
    try {
        ...
        const result = await RatingAndReview.aggregate([
            ...
            {
                $group: { _id:null, averageRating: { $avg: `${rating}`} }                //criteria id=null means all entries in single group and use avg operator on all ratings
            }
        ])
...
//getAllRatingAndreviews of a single course