...
const ExploreMore = () => {
  ...
  return (
    <div className='flex flex-col items-center relative'>
        ...
        <div className='flex flex-row gap-2 rounded-full bg-richblack-700 mb-5 mt-5 border-richblack-100
        px-1 py-1'>
            {
        ...
        <div className='absolute top-44 flex flex-row gap-10 justify-between'>
            {
